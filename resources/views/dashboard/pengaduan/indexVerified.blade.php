            ...
            <div class="w-full mb-12 xl:mb-0 px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                    <div class="flex mx-5 my-5 border-2 w-fit rounded">
                        ...
                        <div class="py-1 px-2 border-r-2 bg-blue-500 text-white">
                            Verified
                        </div>
                        ...
                        <table class="items-center w-full bg-transparent border-collapse">
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        class=" bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left w-5/12">
                                        Judul
                                    </th>
                                    <th
                                    ...
                                    <th
                                        class="px-4 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left w-2/12">
                                        Date
                                    </th>
                                    <th
                        ...
                        <table class="items-center w-full bg-transparent border-collapse">
                            <div>
                                <tbody class="overflow-y-scroll">
                                    ...
                                    <tr class="">
                                        <td
                                            class="border-t-2 pl-4 align-middle text-sm whitespace-nowrap py-3 text-blue-400 font-medium w-1/12">
                                            Verified
                                        </td>

                                        <td
                                            class="border-t-2 align-middle text-sm whitespace-nowrap py-3 font-mediumtext-left w-5/12 truncate">
                                            {{$item->judul}}
                                        </td>
                                        ...
                                        <td
                                            ...
                                            {{-- <i class="fas fa-arrow-up text-emerald-500 mr-4"></i> --}}
                                            {{-- {{date('l, d F Y', strtotime($item->created_at))}} --}}
                                            <a href="{{Route('admin.tanggapan', $item->id)}}"
                                                class="bg-blue-900 p-2 text-white rounded"><i
                                                    class="fas fa-file-alt px-1 text-sm"></i></a>
